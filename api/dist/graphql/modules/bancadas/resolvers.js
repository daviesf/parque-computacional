...
var _default = {
  Query: {
    bancadas: function () {
      var _bancadas = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", knex("bancadas").select("*"));
            case 1:
            case "end":
    ...
    bancada: function () {
      var _bancada = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_, _ref) {
    ...
    bancadasByLocal: function () {
      var _bancadasByLocal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(_, _ref2) {
        var local, bancadas;
    ...
    bancadasByStatus: function () {
      var _bancadasByStatus = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_, _ref3) {
        var status, bancadas;
    ...
    searchBancadas: function () {
      var _searchBancadas = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(_, _ref4) {
        var filter, bancadas;
          ...
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              return knex("bancadas").where(function (builder) {
                if (filter.local) {
                  builder.where("local", "like", "%".concat(filter.local, "%"));
                }
                if (filter.status) {
  ...
  Mutation: {
    createBancada: function () {
      var _createBancada = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(_, _ref5) {
    ...
    updateBancada: function () {
      var _updateBancada = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(_, _ref6) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 3;
              return knex("bancadas").where("idBancada", idBancada).update(data);
            case 3:
    ...
    deleteBancada: function () {
      var _deleteBancada = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(_, _ref7) {
        var idBancada;
